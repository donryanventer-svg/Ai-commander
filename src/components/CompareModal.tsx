              ...
              {models.map((m) => {
                ...
                return (
                  <tr key={m.id} className="hover:bg-[#141414] transition-colors">
                    <td className="py-3.5 pr-4">
                      <div className="font-semibold text-[#f3f3f3] flex items-center gap-2">
                        {m.isCustom ? (
                          ...
                          <Cloud className="w-3.5 h-3.5 text-[#c5a47e]" />
                        )}
                        <span>{m.name}</span>
                        {m.isCustom && (
                          <span className="text-[9px] px-1.5 py-0.2 bg-[#c5a47e]/15 text-[#c5a47e] rounded font-mono border border-[#c5a47e]/30">
                            Tuned
                          </span>
                        )}
                      </div>
                    ...
                    <td className="py-3.5 pr-4 font-mono text-[#c5a47e]">{m.context} tokens</td>
                    ...
                    <td className="py-3.5 text-right">
                      {isSelected ? (
                        <span className="inline-flex items-center gap-1 text-[11px] font-mono text-[#c5a47e] font-semibold">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 bg-[#181818] border border-[#2a2a2a] hover:bg-[#c5a47e] hover:text-[#080808] hover:border-[#c5a47e] text-[#e0e0e0] text-xs font-medium rounded transition-colors cursor-pointer"
                        >
                          Select
                        </button>
                      )}
