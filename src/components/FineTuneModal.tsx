        ...
        <div className="p-5 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#111111] border border-[#262626] rounded px-3 py-1.5 text-[#f3f3f3] focus:border-[#c5a47e] focus:outline-none"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                disabled={running || isFinished}
                className="w-full bg-[#111111] border border-[#262626] rounded px-3 py-1.5 text-[#f3f3f3] focus:border-[#c5a47e]"
              >
          ...
          {(running || isFinished) && (
            <div className="blueprint bg-[#080808] border border-[#1f1f1f] p-4 rounded space-y-3">
              ...
              <div className="flex items-center justify-between font-mono">
                ...
                <span className="text-[#c5a47e]/80">Loss: {loss}</span>
              </div>
              ...
              {isFinished && (
                <div className="pt-2 border-t border-[#1a1a1a] flex items-center gap-2 text-[#c5a47e]">
        ...
        <div className="p-4 bg-[#080808] border-t border-[#1a1a1a] flex items-center justify-end gap-2">
          {!isFinished ? (
            <button
              ...
              disabled={running}
              className="blueprint h-8 px-4 bg-[#c5a47e] hover:bg-[#d8b995] text-[#080808] font-semibold text-xs rounded transition-colors cursor-pointer flex items-center gap-1.5 disabled:opacity-50 uppercase font-mono tracking-wider"
            >
              <i className="corner tl" />
              <i className="corner tr" />
              <i className="corner bl" />
            ...
            <button
              ...
              className="blueprint h-8 px-4 bg-[#c5a47e] hover:bg-[#d8b995] text-[#080808] font-semibold text-xs rounded transition-colors cursor-pointer flex items-center gap-1.5 uppercase font-mono tracking-wider"
            >
              <i className="corner tl" />
              <i className="corner tr" />
              <i className="corner bl" />
