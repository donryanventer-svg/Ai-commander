        ...
        <div className="p-5 space-y-5 overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className={`p-3.5 rounded-lg border transition-all ${
              isAndroid
                ? 'bg-[#c5a47e]/10 border-[#c5a47e]/40'
                : 'bg-[#141414] border-[#222222]'
            }`}>
              <div className="flex items-center gap-2 mb-2 text-[#c5a47e]">
          ...
          <div className="bg-[#121212] border border-[#1f1f1f] rounded-lg p-3.5 space-y-2.5">
            <div className="flex items-start gap-3">
              <WifiOff className="w-4 h-4 text-[#c5a47e] mt-0.5 flex-none" />
              <div>
            ...
            <div className="flex items-start gap-3">
              <Layers className="w-4 h-4 text-[#c5a47e] mt-0.5 flex-none" />
              <div>
            ...
            <div className="p-3 bg-[#171717] rounded-lg border border-[#2a2a2a] text-xs text-[#b0b0b0] space-y-2">
              ...
              {isAndroid ? (
                <p className="leading-relaxed">
                  In Chrome / Samsung Internet on Android, tap the three dots (<span className="font-bold text-white">⋮</span>) in the top-right corner, then tap <span className="font-medium text-[#c5a47e]">"Install app"</span> or <span className="font-medium text-[#c5a47e]">"Add to Home screen"</span>.
                </p>
              ) : isIOS ? (
                <p className="leading-relaxed flex items-center gap-1.5">
                  <Share2 className="w-4 h-4 text-[#c5a47e] inline" />
                  Tap the Share button at the bottom of Safari, then tap <span className="font-medium text-[#c5a47e]">"Add to Home Screen"</span>.
                </p>
              ) : (
                <p className="leading-relaxed">
                  On Chrome or Edge for PC, look for the install icon (<Download className="w-3.5 h-3.5 inline text-[#c5a47e]" />) on the right side of the address bar, or click Menu (<span className="font-bold text-white">⋮</span>) &rarr; <span className="font-medium text-[#c5a47e]">"Install Forge Control Engine"</span>.
                </p>
              )}
            </div>
          )}
        ...
        <div className="p-4 border-t border-[#1c1c1c] bg-[#121212] flex items-center justify-between">
          ...
          {!isInstalled && (
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#c5a47e] hover:bg-[#d8b58d] text-black font-semibold text-xs rounded-md shadow transition-all cursor-pointer font-mono uppercase tracking-wider"
            >
