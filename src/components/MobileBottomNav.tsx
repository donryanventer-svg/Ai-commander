    ...
    >
      ...
      <button
        ...
        className={`flex flex-col items-center justify-center w-14 h-12 rounded-lg transition-colors ${
          currentView === 'chat'
            ? 'text-[#c5a47e] bg-[#c5a47e]/10 font-semibold'
      ...
      >
        <Sparkles className="w-5 h-5 mb-0.5 text-[#c5a47e]" />
      ...
      {!isInstalled && (
        <button
          ...
          className="flex flex-col items-center justify-center w-14 h-12 rounded-lg text-[#c5a47e] bg-[#c5a47e]/15 border border-[#c5a47e]/30 active:scale-95 transition-all"
        >
