        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
          <div>
            <h2 className="text-xl sm:text-2xl font-serif text-[#f3f3f3] flex items-center gap-2.5">
              <Bot className="w-5 h-5 text-[#c5a47e] flex-none" />
          ...
          {mode === 'list' && activeTab === 'models' && (
            <button
              ...
              className="blueprint h-9 px-4 flex items-center justify-center gap-2 bg-[#c5a47e] hover:bg-[#d8b995] text-[#080808] font-semibold text-xs rounded transition-colors cursor-pointer shadow-sm uppercase font-mono tracking-wider w-full sm:w-auto"
            >
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-3 md:px-4 py-2.5 text-xs font-semibold uppercase tracking-wider border-b-2 transition-colors cursor-pointer font-mono whitespace-nowrap ${
                  isActive
                    ? 'border-[#c5a47e] text-[#c5a47e] bg-[#c5a47e]/10'
      ...
      <div className="flex-1 overflow-y-auto px-4 md:px-8 py-4 md:py-6">
            ...
            {mode === 'list' ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl">
                  ...
                  >
                    ...
                    <div>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2.5">
                          <div className="w-8 h-8 rounded bg-[#c5a47e]/10 border border-[#c5a47e]/25 flex items-center justify-center text-[#c5a47e]">
                    ...
                    <div className="flex items-center gap-2 pt-3 border-t border-[#1a1a1a]">
                      <button
                        ...
                        className="blueprint flex-1 h-8 flex items-center justify-center gap-1.5 bg-[#c5a47e] hover:bg-[#d8b995] text-[#080808] font-semibold text-xs rounded transition-colors cursor-pointer uppercase font-mono tracking-wider"
                      >
                        <i className="corner tl" />
                        <i className="corner tr" />
                        <i className="corner bl" />
                ...
                <button
                  type="button"
                  onClick={startNewModel}
                  className="blueprint min-h-[160px] border border-dashed border-[#222222] hover:border-[#c5a47e]/60 hover:bg-[#c5a47e]/5 rounded p-6 flex flex-col items-center justify-center gap-2 text-[#737373] hover:text-[#c5a47e] transition-all cursor-pointer group bg-[#0a0a0a]"
                >
                  <i className="corner tl" />
                  <i className="corner tr" />
                  <i className="corner bl" />
                  <i className="corner br" />
                  <div className="w-10 h-10 rounded-full bg-[#141414] border border-[#222222] group-hover:border-[#c5a47e]/40 flex items-center justify-center text-[#c5a47e] transition-colors">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                  ...
                  <div className="lg:col-span-7 space-y-5">
                    ...
                    <div className="blueprint bg-[#0a0a0a] border border-[#1a1a1a] rounded p-4 space-y-3.5">
                      <i className="corner tl" />
                      <i className="corner tr" />
                      <div className="text-xs font-semibold text-[#c5a47e] uppercase tracking-wider font-mono">
                      ...
                      <div className="space-y-3 text-xs">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full bg-[#121212] border border-[#242424] rounded px-3 py-2 text-[#f3f3f3] focus:border-[#c5a47e] focus:outline-none"
                          />
                        </div>
                        <div>
                      ...
                      <div className="space-y-3 text-xs">
                        <div>
                          ...
                          <textarea
                            ...
                            rows={3}
                            className="w-full bg-[#121212] border border-[#242424] rounded p-2.5 text-[#f3f3f3] focus:border-[#c5a47e] focus:outline-none resize-none leading-relaxed font-sans"
                          />
                        </div>
                        <div>
                          <label className="block text-[#c5a47e] font-medium mb-1">
                          ...
                          <textarea
                            ...
                            rows={3}
                            className="w-full bg-[#121212] border border-[#c5a47e]/40 rounded p-2.5 text-[#f3f3f3] focus:border-[#c5a47e] focus:outline-none resize-none leading-relaxed font-sans"
                          />
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="bg-[#121212] border border-[#222222] rounded p-3.5 space-y-2.5 text-xs">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full bg-[#0a0a0a] border border-[#262626] rounded px-3 py-1.5 text-[#f3f3f3] focus:border-[#c5a47e] focus:outline-none"
                          />
                        </div>
                        <div>
                          <label className="block text-[#888888] text-[11px] mb-1 font-medium font-mono">
                          ...
                          <textarea
                            ...
                            rows={3}
                            className="w-full bg-[#0a0a0a] border border-[#262626] rounded p-2 text-[#f3f3f3] focus:border-[#c5a47e] focus:outline-none resize-none leading-relaxed font-mono text-[11px]"
                          />
                        </div>
                        <button
                          type="button"
                          onClick={addExemplar}
                          className="h-7 px-3 bg-[#1c1c1c] hover:bg-[#262626] text-[#c5a47e] font-medium text-xs rounded transition-colors cursor-pointer flex items-center gap-1.5 border border-[#333333]"
                        >
                      ...
                      <div className="space-y-2">
                        {builderExemplars.map((ex, idx) => (
                          ...
                          >
                            ...
                            <div className="text-[#c5a47e] font-semibold pr-6">
                              Prompt: {ex.input}
                            </div>
                    ...
                    <div className="blueprint bg-[#0a0a0a] border border-[#1a1a1a] rounded p-4 space-y-3">
                      ...
                      <div
                        ...
                        className="border border-dashed border-[#262626] hover:border-[#c5a47e]/60 rounded p-6 flex flex-col items-center justify-center gap-2 cursor-pointer transition-colors text-[#737373] hover:text-[#c5a47e] bg-[#0d0d0d]"
                      >
                  ...
                  <div className="lg:col-span-5 sticky top-4 space-y-4">
                    <div className="blueprint bg-[#0a0a0a] border border-[#222222] shadow-2xl rounded flex flex-col h-[580px]">
                          ...
                          >
                            <div
                              className={`max-w-[90%] p-2.5 rounded text-xs leading-relaxed whitespace-pre-wrap ${
                                m.role === 'user'
                                  ? 'bg-[#c5a47e]/15 text-[#f5ede4] border border-[#c5a47e]/35'
                      ...
                      <div className="p-3 border-t border-[#1a1a1a] flex items-center gap-2 bg-[#0e0e0e]">
                        <input
                          ...
                          className="flex-1 bg-[#141414] border border-[#262626] rounded px-3 py-1.5 text-xs text-[#f3f3f3] focus:border-[#c5a47e] focus:outline-none"
                        />
                        <button
                          type="button"
                          onClick={handleSandboxSend}
                          className="h-7 w-7 bg-[#c5a47e] hover:bg-[#d8b995] text-[#080808] rounded flex items-center justify-center transition-colors cursor-pointer"
                        >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="blueprint flex-1 h-9 bg-[#c5a47e] hover:bg-[#d8b995] text-[#080808] text-xs font-semibold rounded transition-colors cursor-pointer shadow-md uppercase font-mono tracking-wider"
                      >
                        <i className="corner tl" />
                        <i className="corner tr" />
                        <i className="corner bl" />
            ...
            <div className="blueprint bg-[#0a0a0a] border border-[#1a1a1a] rounded p-4 space-y-3">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-[#121212] border border-[#242424] rounded px-3 py-2 text-xs text-[#f3f3f3] focus:border-[#c5a47e] focus:outline-none"
                />
                <button
                  type="button"
                  onClick={handleAddMemory}
                  className="blueprint px-4 bg-[#c5a47e] hover:bg-[#d8b995] text-[#080808] font-semibold text-xs rounded transition-colors cursor-pointer whitespace-nowrap uppercase font-mono tracking-wider"
                >
                  <i className="corner tl" />
                  <i className="corner tr" />
                  <i className="corner bl" />
                  ...
                  <div key={m.id} className="p-3.5 flex items-start gap-3 text-xs">
                    <button
                      ...
                      className={`p-1.5 rounded transition-colors flex-none cursor-pointer ${
                        m.pinned ? 'text-[#c5a47e] bg-[#c5a47e]/15' : 'text-[#666666] hover:text-[#f3f3f3]'
                      }`}
                    >
            ...
            <div className="space-y-3 pt-4 border-t border-[#1a1a1a]">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="blueprint h-8 px-3.5 flex items-center gap-1.5 bg-[#141414] hover:bg-[#1f1f1f] text-[#c5a47e] text-xs font-semibold rounded transition-colors cursor-pointer border border-[#262626]"
                >
                  <i className="corner tl" />
                  <i className="corner tr" />
                  <i className="corner bl" />
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`text-[9px] px-1.5 py-0.5 rounded font-mono ${
                            tr.applied
                              ? 'bg-[#c5a47e]/20 text-[#c5a47e] border border-[#c5a47e]/35'
        ...
        {activeTab === 'skills' && (
          <div className="max-w-4xl space-y-4">
            ...
            {/* Modal to add skill */}
            {newSkillOpen && (
              <div className="blueprint bg-[#0d0d0d] border border-[#c5a47e]/50 p-4 rounded space-y-3">
                <i className="corner tl" />
                <i className="corner tr" />
                <i className="corner bl" />
                <i className="corner br" />
                <div className="font-semibold text-xs text-[#c5a47e] uppercase tracking-wider font-mono">
                ...
                <div className="space-y-2 text-xs">
                  <input
                    ...
                    className="w-full bg-[#141414] border border-[#282828] rounded px-3 py-1.5 text-[#f3f3f3] focus:border-[#c5a47e] focus:outline-none"
                  />
                  <input
                    type="text"
                    value={newSkillDesc}
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full bg-[#141414] border border-[#282828] rounded p-2 text-[#f3f3f3] focus:border-[#c5a47e] focus:outline-none resize-none"
                  />
                </div>
                <div className="flex justify-end gap-2">
                  ...
                  <button
                    ...
                    className="px-3.5 py-1 bg-[#c5a47e] hover:bg-[#d8b995] text-[#080808] font-semibold text-xs rounded uppercase font-mono tracking-wider cursor-pointer"
                  >
                    Register Protocol
                  </button>
                </div>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2 pt-1">
                    {sk.steps.map((st, sIdx) => (
                      ...
                      >
                        <span className="text-[#c5a47e] font-mono font-semibold">{sIdx + 1}.</span>
                        <span>{st}</span>
                      </div>
                    ))}
                  </div>
