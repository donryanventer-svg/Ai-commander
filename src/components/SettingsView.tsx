          ...
          <div className="flex md:flex-col gap-1 px-3 min-w-max md:min-w-0">
            <button
              ...
              className={`flex items-center gap-2.5 px-3 py-2 text-xs font-medium rounded transition-colors cursor-pointer whitespace-nowrap ${
                activeTab === 'providers'
                  ? 'bg-[#c5a47e]/15 text-[#c5a47e] font-semibold border border-[#c5a47e]/30'
                  : 'text-[#888888] hover:bg-[#141414] hover:text-[#f3f3f3]'
              }`}
            >
              <Server className="w-3.5 h-3.5 text-[#c5a47e] flex-none" />
            ...
            >
              <Volume2 className="w-3.5 h-3.5 text-[#c5a47e] flex-none" />
            ...
            >
              <Sliders className="w-3.5 h-3.5 text-[#c5a47e] flex-none" />
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3 text-xs pt-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#111111] border border-[#262626] rounded px-3 py-2 text-[#f3f3f3] font-mono text-xs focus:border-[#c5a47e] focus:outline-none"
                  />
                ...
                {testResult && (
                  <div
                    className={`p-2.5 rounded text-xs flex items-center gap-2 ${
                      testResult.success
                        ? 'bg-[#c5a47e]/15 text-[#e6d0b3] border border-[#c5a47e]/30'
                        : 'bg-red-500/15 text-red-300 border border-red-500/30'
                    }`}
                  >
                    {testResult.success ? (
                      <CheckCircle2 className="w-4 h-4 flex-none text-[#c5a47e]" />
                    ) : (
                ...
                <div className="flex items-center gap-2 pt-2">
                  ...
                  {!customEndpoint.connected ? (
                    <button
                      ...
                      className="blueprint h-8 px-4 bg-[#c5a47e] hover:bg-[#d8b995] text-[#080808] font-semibold text-xs rounded transition-colors cursor-pointer flex items-center gap-1.5 shadow-sm uppercase font-mono tracking-wider"
                    >
                      <i className="corner tl" />
                      <i className="corner tr" />
                      <i className="corner bl" />
            ...
            <div className="blueprint bg-[#0a0a0a] border border-[#1c1c1c] rounded p-4 space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-mono px-2 py-0.5 bg-[#c5a47e]/15 text-[#c5a47e] rounded border border-[#c5a47e]/30">
                  Production Integration Active
                </span>
              </div>
              <p className="text-xs text-[#888888] leading-relaxed">
                Atlas Large (powered by Gemini 3.1 Pro) and Atlas Fast (powered by Gemini 3.8 Flash) are natively supported server-side via the official <code className="text-[#c5a47e]">@google/genai</code> SDK with automatic fallback handling.
              </p>
            </div>
          </div>
        )}
            ...
            <div className="blueprint bg-[#0a0a0a] border border-[#1c1c1c] rounded p-5 space-y-4 text-xs">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-[#111111] border border-[#262626] rounded px-3 py-2 text-[#f3f3f3] focus:border-[#c5a47e] focus:outline-none"
                >
              ...
              <div className="pt-2 border-t border-[#1c1c1c] flex items-center justify-between">
                ...
                <button
                  ...
                  className={`w-9 h-5 rounded-full relative transition-colors cursor-pointer ${
                    voiceSettings.autoReadAloud ? 'bg-[#c5a47e]' : 'bg-[#222222]'
                  }`}
                >
                  <span
          ...
          <div className="space-y-6">
            ...
            <div className="blueprint bg-[#0a0a0a] border border-[#1c1c1c] rounded p-5 space-y-3 text-xs">
              ...
              <div className="grid grid-cols-4 gap-2">
                {[
                  { id: 'gold', label: 'Vintage Gold', color: '#c5a47e' },
