            ...
            return (
              <div
                ...
                className={`group flex items-center justify-between px-2.5 py-2 text-xs rounded transition-all cursor-pointer ${
                  isActive
                    ? 'bg-[#c5a47e]/15 text-[#ffffff] border border-[#c5a47e]/40'
              ...
              >
                {isRenaming ? (
                  <input
                    ...
                    className="w-full bg-[#111111] text-[#f3f3f3] px-1.5 py-0.5 rounded border border-[#c5a47e] text-xs focus:outline-none"
                  />
                ) : (
                  <>
                    <div className="flex items-center gap-2 min-w-0 flex-1 pr-1">
                      <MessageSquare className="w-3.5 h-3.5 flex-none opacity-80 text-[#c5a47e]" />
    ...
    <>
      ...
      >
        ...
        <div className="md:hidden flex items-center justify-between px-3.5 py-3 border-b border-[#1c1c1c] bg-[#121212]">
          <span className="text-xs font-semibold text-[#c5a47e] font-mono uppercase tracking-wider">
            Threads & Workspaces
          </span>
          <button
            type="button"
        ...
        <div className="p-3 pb-2">
          <button
            ...
            className="blueprint w-full h-[38px] flex items-center justify-center gap-2 bg-[#c5a47e] hover:bg-[#d8b995] text-[#080808] font-semibold text-xs transition-colors rounded-sm cursor-pointer shadow-sm tracking-wide uppercase font-mono"
          >
      ...
      <div className="px-3 pb-2">
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-[#111111] border border-[#222222] rounded-sm pl-8 pr-2.5 py-1.5 text-xs text-[#f3f3f3] placeholder-[#555555] focus:border-[#c5a47e] transition-colors"
          />
        </div>
      </div>
      ...
      <div className="p-2 border-t border-[#1c1c1c] space-y-1 bg-[#0a0a0a]">
        {onOpenHuggingFaceModal && (
          ...
          >
            ...
            {huggingFaceUser ? (
              ...
              <span className="text-[10px] text-[#666666] group-hover:text-[#c5a47e] transition-colors font-mono">
                Connect
              </span>
            )}
          </button>
        ...
        {onOpenInstallModal && (
          <button
            ...
            className="w-full flex items-center justify-between px-3 py-2 text-xs font-medium rounded-sm transition-colors cursor-pointer text-[#c5a47e] bg-[#c5a47e]/10 hover:bg-[#c5a47e]/20 border border-[#c5a47e]/30 group"
          >
            <div className="flex items-center gap-2.5 min-w-0">
              <Download className="w-4 h-4 text-[#c5a47e] flex-none" />
              <span className="truncate">Install App</span>
            </div>
            <span className="text-[10px] font-mono text-[#c5a47e] px-1.5 py-0.5 rounded bg-[#c5a47e]/15">
              Android / PC
            </span>
          </button>
        )}
        ...
        >
          <div className="flex items-center gap-2.5 min-w-0">
            <Sparkles className="w-4 h-4 text-[#c5a47e] flex-none" />
            <span className="truncate">Neural Image Studio</span>
          </div>
          <span className="text-[9px] font-mono text-[#c5a47e] px-1.5 py-0.5 rounded bg-[#c5a47e]/15">
            Gen & Remix
          </span>
        </button>
        ...
        >
          <FlaskConical className="w-4 h-4 text-[#c5a47e] flex-none" />
        ...
        >
          <Settings className="w-4 h-4 text-[#c5a47e] flex-none" />
          <span>Settings</span>
        </button>
      </div>
    </aside>
