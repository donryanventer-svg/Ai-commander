  ...
  return (
    ...
    >
      <div className="flex items-center gap-1.5 md:gap-2 min-w-0">
        ...
        {hasCustomEndpoint && (
          <span className="hidden sm:inline-flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] bg-[#c5a47e]/15 text-[#c5a47e] border border-[#c5a47e]/30">
      ...
      <div className="flex items-center gap-1 h-full">
        ...
        {!isInstalled && onOpenInstallModal && (
          <button
            ...
            className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-[11px] font-medium font-mono cursor-pointer transition-all bg-[#c5a47e]/20 hover:bg-[#c5a47e]/30 border border-[#c5a47e]/50 text-[#f5dfc6]"
            title={isAndroid ? 'Install Forge as Android App' : 'Install Forge as Desktop PC App'}
          >
            {isAndroid ? (
              <Smartphone className="w-3 h-3 text-[#c5a47e]" />
            ) : (
              <Monitor className="w-3 h-3 text-[#c5a47e]" />
            )}
