      ...
      <div className="p-3.5 space-y-4 text-xs">
        ...
        <div className="space-y-3 pt-2 border-t border-[#1a1a20]">
          ...
          <div>
            <div className="flex items-center justify-between text-[11px] mb-1">
              <span className="flex items-center gap-1.5 text-[#b5b5c0]">
                <Sun className="w-3.5 h-3.5 text-[#c5a47e]" /> Brightness
              </span>
            ...
            <input
              ...
              className="w-full accent-[#c5a47e] cursor-pointer h-1.5 bg-[#1e1e24] rounded-lg appearance-none"
            />
          </div>
          ...
          <div>
            <div className="flex items-center justify-between text-[11px] mb-1">
              <span className="flex items-center gap-1.5 text-[#b5b5c0]">
                <Contrast className="w-3.5 h-3.5 text-[#c5a47e]" /> Contrast
              </span>
          ...
          <div>
            <div className="flex items-center justify-between text-[11px] mb-1">
              <span className="flex items-center gap-1.5 text-[#b5b5c0]">
                <Droplets className="w-3.5 h-3.5 text-[#c5a47e]" /> Saturation
              </span>
          ...
          <div>
            <div className="flex items-center justify-between text-[11px] mb-1">
              <span className="flex items-center gap-1.5 text-[#b5b5c0]">
                <Flame className="w-3.5 h-3.5 text-[#c5a47e]" /> Warmth / Temp
              </span>
        ...
        <div className="space-y-3 pt-2 border-t border-[#1a1a20]">
          ...
          <div>
            <div className="flex items-center justify-between text-[11px] mb-1">
              <span className="flex items-center gap-1.5 text-[#b5b5c0]">
                <CircleDot className="w-3.5 h-3.5 text-[#c5a47e]" /> Edge Vignette
              </span>
          ...
          <div>
            <div className="flex items-center justify-between text-[11px] mb-1">
              <span className="flex items-center gap-1.5 text-[#b5b5c0]">
                <Sparkles className="w-3.5 h-3.5 text-[#c5a47e]" /> Film Grain
              </span>
          ...
          <div>
            <div className="flex items-center justify-between text-[11px] mb-1">
              <span className="flex items-center gap-1.5 text-[#b5b5c0]">
                <Eye className="w-3.5 h-3.5 text-[#c5a47e]" /> Soft Focus / Blur
              </span>
        ...
        <div className="pt-2 border-t border-[#1a1a20]">
          <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#888892] font-mono mb-2 flex items-center justify-between">
            <span className="flex items-center gap-1.5">
              <Type className="w-3.5 h-3.5 text-[#c5a47e]" /> Watermark Stamp
            </span>
          </div>
          <input
            type="text"
            ...
            className="w-full px-2.5 py-1.5 text-xs bg-[#121216] border border-[#24242c] rounded text-white focus:outline-none focus:border-[#c5a47e]"
          />
