...
export const ImageCompareSlider: React.FC<ImageCompareSliderProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Divider Bar */}
      <div
        className="absolute top-0 bottom-0 z-10 w-0.5 bg-[#c5a47e] pointer-events-none shadow-[0_0_10px_rgba(197,164,126,0.6)]"
        style={{ left: `${sliderPos}%` }}
      >
        {/* Handle Knob */}
        <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-[#121216] border-2 border-[#c5a47e] flex items-center justify-center text-[#c5a47e] shadow-xl">
      ...
      <div className="absolute top-3 right-3 px-2 py-1 bg-[#0a0a0e]/80 backdrop-blur-md rounded border border-[#26262e] text-[10px] font-mono text-[#c5a47e] pointer-events-none">
        {modifiedLabel}
      </div>
    </div>
  );
