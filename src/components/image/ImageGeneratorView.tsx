      ...
      <div className="flex-none h-11 border-b border-[#1b1b22] px-3 md:px-4 flex items-center justify-between bg-[#0a0a0e]">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="hidden sm:flex items-center gap-1 text-[11px] font-mono text-[#8b8b99]">
            <span>Engine:</span>
            <span className="text-[#c5a47e] bg-[#c5a47e]/10 px-1.5 py-0.5 rounded border border-[#c5a47e]/25">
            ...
            <div className="flex items-center border border-[#24242e] rounded bg-[#111116] p-0.5">
              <button
                ...
                className={`px-2 py-1 text-[10px] font-mono rounded transition-colors ${
                  viewMode === 'normal' ? 'bg-[#c5a47e]/20 text-white font-medium' : 'text-[#888892]'
                }`}
              >
                Canvas
              </button>
              <button
                ...
                className={`flex items-center gap-1 px-2 py-1 text-[10px] font-mono rounded transition-colors ${
                  viewMode === 'compare' ? 'bg-[#c5a47e]/20 text-white font-medium' : 'text-[#888892]'
                }`}
              >
                <SplitSquareVertical className="w-3 h-3 text-[#c5a47e]" />
          ...
          <div className="p-3.5 space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#8e8e9c] font-mono flex items-center gap-1.5">
                  <Wand2 className="w-3.5 h-3.5 text-[#c5a47e]" />
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="flex items-center gap-1 px-1.5 py-0.5 text-[10px] font-mono text-[#a3a3a3] hover:text-[#c5a47e] bg-[#141418] hover:bg-[#1e1e24] rounded border border-[#222228] transition-colors"
                    title="Load random inspiration prompt"
                  >
                    <Dice5 className="w-3 h-3 text-[#c5a47e]" />
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-1.5 py-0.5 text-[10px] font-mono text-[#c5a47e] bg-[#c5a47e]/15 hover:bg-[#c5a47e]/25 rounded border border-[#c5a47e]/30 transition-colors disabled:opacity-40"
              ...
              <div className="relative">
                <textarea
                  ...
                  className="w-full px-3 py-2 text-xs bg-[#111116] border border-[#22222a] rounded text-white focus:outline-none focus:border-[#c5a47e] transition-colors resize-none leading-relaxed"
                />
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center justify-center p-2 rounded text-center border transition-all cursor-pointer ${
                        isSelected
                          ? 'bg-[#c5a47e]/20 border-[#c5a47e] text-white shadow-sm'
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center justify-center p-1.5 rounded border transition-colors cursor-pointer ${
                      aspectRatio === item.ratio
                        ? 'bg-[#c5a47e]/20 border-[#c5a47e] text-white font-medium'
            ...
            <div className="space-y-3 pt-2 border-t border-[#1b1b22]">
                  ...
                  {(['512px', '1K', '2K', '4K'] as const).map((sz) => (
                    <button
                      ...
                      className={`px-2 py-0.5 text-[10px] font-mono rounded transition-colors ${
                        imageSize === sz ? 'bg-[#c5a47e]/20 text-white font-medium' : 'text-[#777784]'
                      }`}
                    >
                      {sz}
                    </button>
              ...
              <div>
                <div className="flex items-center justify-between text-[11px] mb-1">
                  ...
                  <span className="font-mono text-[10px] text-[#c5a47e]">{guidanceScale.toFixed(1)}</span>
                </div>
                <input
                  type="range"
                  min="1"
                  ...
                  className="w-full accent-[#c5a47e] cursor-pointer h-1.5 bg-[#1b1b22] rounded-lg appearance-none"
                />
              </div>
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1">
                  <input
                    ...
                    className="w-24 px-2 py-0.5 text-[10px] font-mono bg-[#111116] border border-[#22222a] rounded text-white focus:outline-none focus:border-[#c5a47e]"
                  />
                  <button
                    type="button"
                  ...
                  >
                    {isSeedLocked ? <Lock className="w-3.5 h-3.5 text-[#c5a47e]" /> : <Unlock className="w-3.5 h-3.5" />}
                  </button>
                </div>
              </div>
              ...
              {showNegative && (
                <div className="mt-2 space-y-2">
                  <textarea
                    ...
                    className="w-full px-2.5 py-1.5 text-xs bg-[#111116] border border-[#22222a] rounded text-white focus:outline-none focus:border-[#c5a47e] resize-none"
                  />
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-2.5 px-4 rounded bg-[#c5a47e] text-black font-semibold text-xs uppercase tracking-wider font-mono hover:bg-[#d6b793] active:scale-[0.99] transition-all flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer shadow-md"
              >
                {isGenerating ? (
                  <>
            ...
            <div className="flex items-center gap-2 pointer-events-auto">
              {activeImage && (
                <div className="flex items-center gap-2 px-2.5 py-1 rounded bg-[#0c0c10]/85 backdrop-blur-md border border-[#22222a] text-[10px] font-mono text-[#a0a0ae]">
                  <span className="text-[#c5a47e] font-semibold">{activeImage.aspectRatio}</span>
                  <span>•</span>
          ...
          <div className="flex-1 flex items-center justify-center p-4 sm:p-8 overflow-hidden relative">
            {isGenerating ? (
              <div className="flex flex-col items-center justify-center space-y-3 z-10">
                <div className="w-12 h-12 rounded-full border-2 border-[#c5a47e] border-t-transparent animate-spin" />
                <div className="text-xs font-mono text-[#c5a47e] tracking-widest uppercase animate-pulse">
            ...
            <div className="flex-none h-12 border-t border-[#1a1a20] px-3 sm:px-5 flex items-center justify-between bg-[#0a0a0e]">
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-mono rounded bg-[#c5a47e]/15 border border-[#c5a47e]/30 text-[#c5a47e] hover:bg-[#c5a47e]/25 transition-colors cursor-pointer"
                ...
                >
                  <Copy className="w-3 h-3 text-[#c5a47e]" />
                ...
                return (
                  <button
                    ...
                    className={`flex-none h-16 w-16 relative rounded overflow-hidden border transition-all cursor-pointer group ${
                      isActive ? 'border-[#c5a47e] ring-1 ring-[#c5a47e]' : 'border-[#22222a] opacity-70 hover:opacity-100'
                    }`}
                  >
                    <img
                      src={item.imageUrl}
                      ...
                      referrerPolicy="no-referrer"
                    />
                    <div className="absolute bottom-0 inset-x-0 bg-black/75 text-[8px] font-mono text-center text-[#c5a47e] truncate px-0.5">
                      {item.aspectRatio}
                    </div>
                  </button>
                );
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="flex items-center gap-3 p-2 bg-[#08080b] rounded border border-[#1b1b22]">
                ...
                <div className="min-w-0 text-xs">
                  <div className="text-[10px] font-mono text-[#c5a47e] uppercase">Source Baseline</div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 text-xs bg-[#14141a] border border-[#24242e] rounded text-white focus:outline-none focus:border-[#c5a47e] resize-none"
                />
              </div>
              ...
              <div>
                <div className="flex items-center justify-between text-xs mb-1">
                  ...
                  <span className="font-mono text-[10px] text-[#c5a47e]">{Math.round(remixStrength * 100)}%</span>
                </div>
                <input
                  type="range"
                  min="0.1"
              ...
              <div className="flex items-center justify-end gap-2 pt-2 border-t border-[#1b1b22]">
                ...
                <button
                  ...
                  onClick={handleRemix}
                  className="px-4 py-1.5 text-xs font-mono font-semibold rounded bg-[#c5a47e] text-black hover:bg-[#d6b793] disabled:opacity-50 transition-colors flex items-center gap-1.5"
                >
                  {isRemixing ? (
                    <>
